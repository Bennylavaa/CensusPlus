...
CENSUSPlus_BUTTON_TEXT      = "Epoch Census";
CENSUSPlus_BUTTON_SUBTEXT   = "Project Epoch Census";
CENSUSPlus_BUTTON_TIP       = "Click here to show or hide Epoch Census.";
CENSUSPlus_HELP             = " Use /censusplus to open and close the Census+ UI.";

CENSUSPlus_MSG1             = " Epoch Census Loaded - type /censusplus or /census+ to open main window";
CENSUSPlus_MSG2             = "Use /censusdate to set today's date in the format of MM-DD-YYYY, ie. 12-25-2004";

CENSUSPlus_UPLOAD           = "Project Epoch - Cross-Faction Census Tool";
